...
export declare class StateService {
    ...
    private transQueue;
    private treeChangesQueue;
    private rejectFactory;
    params: StateParams;
    current: StateDeclaration;
    $current: State;
    transition: Transition;
    constructor($view: ViewService, $stateParams: StateParams, $urlRouter: UrlRouter, $transitions: TransitionService, stateRegistry: StateRegistry, stateProvider: StateProvider);
    /**
