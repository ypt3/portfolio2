...
import { IMatchCriteria, IEventHook, IHookRegistry, TreeChanges, MatchCriterion, IMatchingNodes } from "./interface";
 ...
 * @returns {boolean}
 */
export declare function matchState(state: State, criterion: MatchCriterion): boolean;
export declare class EventHook implements IEventHook {
    callback: IInjectable;
    matchCriteria: IMatchCriteria;
    priority: number;
    constructor(matchCriteria: IMatchCriteria, callback: IInjectable, options?: {
        priority?: number;
    });
...
export declare class HookRegistry implements IHookRegistry {
    ...
    onBefore: (matchCriteria: IMatchCriteria, callback: Function | any[], options?: any) => Function;
    onStart: (matchCriteria: IMatchCriteria, callback: Function | any[], options?: any) => Function;
    /**
     * @ngdoc function
     ...
     */
    onEnter: (matchCriteria: IMatchCriteria, callback: Function | any[], options?: any) => Function;
    /**
     * @ngdoc function
     ...
     * @param {function} callback See callback in {@link ui.router.state.$transitionsProvider#on $transitionsProvider.on}.
     */
    onRetain: (matchCriteria: IMatchCriteria, callback: Function | any[], options?: any) => Function;
    /**
     * @ngdoc function
     ...
     * @param {function} callback See callback in {@link ui.router.state.$transitionsProvider#on $transitionsProvider.on}.
     */
    onExit: (matchCriteria: IMatchCriteria, callback: Function | any[], options?: any) => Function;
    /**
     * @ngdoc function
     ...
     * @param {function} callback See callback in {@link ui.router.state.$transitionsProvider#on $transitionsProvider.on}.
     */
    onFinish: (matchCriteria: IMatchCriteria, callback: Function | any[], options?: any) => Function;
    /**
     * @ngdoc function
     ...
     */
    onSuccess: (matchCriteria: IMatchCriteria, callback: Function | any[], options?: any) => Function;
    /**
     * @ngdoc function
     ...
     *   The function's return value is ignored.
     */
    onError: (matchCriteria: IMatchCriteria, callback: Function | any[], options?: any) => Function;
}
